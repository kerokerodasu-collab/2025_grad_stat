# 09
# README.md
ここは9回目の講義（一元配置分散分析と多重比較）です。 </br>
* 資料はこちらです。レイアウトが違うだけで、中身は同じです。</br>
  * [1ページ1スライド](2025統計学_基礎09.pdf) </br>
  * [1ページ4スライド](2025統計学_基礎09_1P4.pdf)　</br>
(Windowsは右クリックから「名前をつけてリンク先を保存」Macは「リンク先のファイルをダウンロード」などのメニューで保存ができます。※ブラウザによって、多少表記が異なります。)</br>
* 講義内で使用しているデータはこちらです。</br>
  * [data09_01csv](data09_01.csv)  </br>
  * [data09_02csv](data09_02.csv)  </br>
  * [data09_03csv](data09_03.csv)  </br>
(右クリックでメニューからダウンロードができます。)</br> 
* 講義動画はこちらから。 </br>
  * [9回目講義](https://youtu.be/JgMZAan2PIQ)</br>
