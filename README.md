# 10
# README.md
ここは10回目の講義（ノンパラメトリック検定）です。 </br>
* 資料はこちらです。レイアウトが違うだけで、中身は同じです。</br>
  * [1ページ1スライド](2025統計学_基礎10.pdf) </br>
  * [1ページ4スライド](2025統計学_基礎10_1P4.pdf)　</br>
(Windowsは右クリックから「名前をつけてリンク先を保存」Macは「リンク先のファイルをダウンロード」などのメニューで保存ができます。※ブラウザによって、多少表記が異なります。)</br>
* 講義内で使用しているデータはこちらです。</br>
  * [data10_01csv](data10_01.csv)  </br>
  * [data10_02csv](data10_02.csv)  </br>
  * [data10_03csv](data10_03.csv)  </br>
  * [data10_04csv](data10_04.csv)  </br>
(右クリックでメニューからダウンロードができます。)</br> 
* 講義動画はこちらから。 </br>
  * [10回目講義](https://youtu.be/A2JxJIqGUCs)</br> 
